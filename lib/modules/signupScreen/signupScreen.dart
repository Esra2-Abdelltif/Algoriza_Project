                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Align(
                          ...
                          child: InkWell(
                            onTap: (){NavigateTo(context: context,router: LoginScreen());},
                            child: Container(
                              padding: const EdgeInsets.symmetric(horizontal: 10),
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            Text('Register',style: TextStyle(fontWeight: FontWeight.w500,fontSize: 40,color: Colors.black)),
                            Row(
                              children: [
                                Text('Help',
                                  style: TextStyle(
                        ...
                        Form(
                            ...
                            child:Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 15,),
                                CustomTextField(FieldName: 'Password',controller: passController,hintText: 'Password',secirty: _secirty,
                                  textInputType: TextInputType.phone,isPass: true,suffixIcon: IconButton(onPressed: () {
                                    setState(() {
                                      _secirty =!_secirty;
                                    });
                                  },
